...
CREATE TABLE `books` (
  ...
  `bk_ur_id` int(11) DEFAULT NULL,
  `bk_se_id` int(11) DEFAULT NULL,
  `bk_number` int(11) DEFAULT NULL,
  `bk_doc_id` varchar(255) DEFAULT NULL,
  ...
  `bk_cover` longblob,
  `bk_keywords` text COMMENT 'ключевые слова',
...
--
ALTER TABLE `authors`
  MODIFY `ar_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=335;
--
-- AUTO_INCREMENT для таблицы `books`
--
ALTER TABLE `books`
  MODIFY `bk_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=487;
--
-- AUTO_INCREMENT для таблицы `books_authors`
--
ALTER TABLE `books_authors`
  MODIFY `bkar_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=619;
--
-- AUTO_INCREMENT для таблицы `books_genres`
--
ALTER TABLE `books_genres`
  MODIFY `bkge_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=880;
--
...
--
ALTER TABLE `series`
  MODIFY `se_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=303;
--
