...
<section>
    ...
    <div v-else>
        <div class="cover-book-list" v-if="look === 'cover'">
            <div class="series-wrap" v-for="sItem in sListItems" :key="sItem.id" :class="{ shift: isShift }">
                <div class="series-title" v-if="sItem.seriesTitle != 'Ђ'">
                    <span>{{ sItem.seriesTitle }}</span>
                </div>
                <div class="item" v-for="bItem in bListItems" :key="bItem.id" v-if="bItem.seriesTitle == sItem.seriesTitle">
                    <div class="cover">
